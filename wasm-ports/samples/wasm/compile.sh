...
sh build.sh
touch output.wasm
node /emscripten-module-wrapper/prepare.js target/wasm32-unknown-emscripten/release/wasm_sample.js --run --debug --file input.wasm --file output.wasm --out=dist --upload-ipfs
