...
emcc -O2 -I $EMSCRIPTEN/system/include -c -std=c++11 scrypthash.cpp
emcc -O2 -I $EMSCRIPTEN/system/include -c -std=c++11 scrypt.cpp
emcc -o scrypt.js scrypthash.o scrypt.o -lcrypto -lssl
