...
const PATH_OCAML_OFFCHAIN_INTERPRETER = process.env.PATH_OCAML_OFFCHAIN_INTERPRETER || dir + "../ocaml-offchain/interpreter/wasm";
const PATH_WEBASM_SOLIDITY_CONFIG = process.env.PATH_OCAML_OFFCHAIN_INTERPRETER || dir + "../webasm-solidity/node/config.json";
...
function readConfig() {
  try {
    config = JSON.parse(
      fs.readFileSync(PATH_WEBASM_SOLIDITY_CONFIG)
    );
  } catch (e) {}
}
...
var wasm = PATH_OCAML_OFFCHAIN_INTERPRETER;
