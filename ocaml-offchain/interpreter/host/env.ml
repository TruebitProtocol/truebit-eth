...
let lookup name t =
  ...
  | "__stack_pointer", ExternalGlobalType t -> ExternalGlobal (I32 0l)
  | "__memory_base", ExternalGlobalType t -> ExternalGlobal (I32 0l)
  | "__table_base", ExternalGlobalType t -> ExternalGlobal (I32 0l)
